  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        setPrices(priceData);
        const latestEthPrice: number = +priceData[priceData.length - 1]?.price * 1000;
        setLatestPriceInEth(latestEthPrice)

        // Get latest ETH price
        const ethRes = await fetch('https://min-api.cryptocompare.com/data/price?fsym=ETH&tsyms=USD&api_key=53159740a064411a742a2c6582cdacfd85ad455c02722eb0005935b583b750cf');
